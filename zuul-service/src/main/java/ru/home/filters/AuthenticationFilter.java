...
public class AuthenticationFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        if ( ctx.getRequest().getRequestURI().equals("/api/authsrv/authenticate")){
            return null;
        }
        ...
        if (userInfo!=null){
            ...
            filterUtils.setType(userInfo.getType());
